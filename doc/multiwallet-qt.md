...
Only requiring some minor changes is gamblr.cpp.
...
Changes to gamblr.cpp
----------------------
gamblr.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
