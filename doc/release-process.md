...
##perform gitian builds
 ...
 Build gamblrd and gamblr-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit gamblr=v${VERSION} ../gamblr/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../gamblr/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r gamblr-${VERSION}-linux-gitian.zip *
	mv gamblr-${VERSION}-linux-gitian.zip ../../../
	popd
	...
	pushd build/out
	zip -r gamblr-${VERSION}-win-gitian.zip *
	mv gamblr-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit gamblr=v${VERSION} ../gamblr/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
