...
4.  (Optional) You can also install gamblrd to your path:
...
4. Enter "gamblr-qt" as project name, enter src/qt as location
...
gamblrd/gamblr-cli binaries are not included in the Gamblr-Qt.app bundle.

If you are building `gamblrd` or `Gamblr-Qt` for others, your build machine should be set up
...
Once dependencies are compiled, see release-process.md for how the Gamblr-Qt.app
