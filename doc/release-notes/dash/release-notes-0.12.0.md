...
Gamblr Core version 0.12.0 is now available from:

  https://gamblr.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/gamblr/gamblr/issues
...
backwards-compatible with pre-0.12 versions of Gamblr Core or other software:
