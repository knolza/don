...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Gamblr Core gamblr-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gamblr-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gamblr transaction") + "\n" +
              "  gamblr-tx [options] -create [commands]   " + _("Create hex-encoded gamblr transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gamblr transaction
