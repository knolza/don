...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: gamblrd.pid)") + "\n";
    ...
    strUsage += "  -anonymizegamblramount=<n> " + _("Keep N gamblr anonymized (default: 0)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 7776 or testnet: 19998)") + "\n";
    ...
    if (fDisableWallet) {
        ...
        if (nLoadWalletRet != DB_LOAD_OK)
        {
            ...
            else if (nLoadWalletRet == DB_NONCRITICAL_ERROR)
            {
                ...
                strErrors << _("Error loading wallet.dat: Wallet requires newer version of Gamblr") << "\n";
            else if (nLoadWalletRet == DB_NEED_REWRITE)
            {
                strErrors << _("Wallet needed to be rewritten: restart Gamblr to complete") << "\n";
