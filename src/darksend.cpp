...
/* *** BEGIN DARKSEND MAGIC - CHIP **********
    Copyright (c) 2014-2015, Gamblr Developers
        eduffield - evan@gamblrpay.io
        udjinm6   - udjinm6@gamblrpay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Gamblr and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun, bool ready)
{
    ...
    int64_t nBalanceNeedsAnonymized = nAnonymizeGamblrAmount*COIN - pwalletMain->GetAnonymizedBalance();
    ...
    if(!sessionFoundMasternode){
        ...
        LogPrintf("Submitting Darksend for %f CHIP CENT - sessionTotalValue %d\n", fDarkcoinSubmitted, sessionTotalValue);
