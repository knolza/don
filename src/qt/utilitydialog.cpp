    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Gamblr Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Gamblr Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  gamblr-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Gamblr Core is shutting down...") + "<br /><br />" +
