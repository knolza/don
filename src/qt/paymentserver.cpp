...
const char* BITCOIN_REQUEST_MIMETYPE = "application/gamblr-paymentrequest";
const char* BITCOIN_PAYMENTACK_MIMETYPE = "application/gamblr-paymentack";
const char* BITCOIN_PAYMENTACK_CONTENTTYPE = "application/gamblr-payment";
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // gamblr: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
                ...
                emit message(tr("URI handling"),
                    tr("URI can not be parsed! This can be caused by an invalid Gamblr address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
