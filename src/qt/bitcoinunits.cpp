...
QString BitcoinUnits::id(int unit)
{
    switch(unit)
    {
        case CHIP: return QString("gamblr");
        case mCHIP: return QString("mgamblr");
        case uCHIP: return QString::fromUtf8("ugamblr");
...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkID() == CBaseChainParams::MAIN)
    {
        ...
        {
            case CHIP: return QString("Gamblr");
            case mCHIP: return QString("Milli-Gamblr (1 / 1" THIN_SP_UTF8 "000)");
            case uCHIP: return QString("Micro-Gamblr (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-Gamblr (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case CHIP: return QString("TestGamblrs");
            case mCHIP: return QString("Milli-TestGamblr (1 / 1" THIN_SP_UTF8 "000)");
            case uCHIP: return QString("Micro-TestGamblr (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-TestGamblr (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}
