...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gamblr Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gamblr Core"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gamblr Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Gamblr Core"); // default title
