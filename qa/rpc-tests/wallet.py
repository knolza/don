...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 CHIP, node2 has none. 
#   d) node0 sends 21 CHIP to node2, in two transactions (11 CHIP, then 10 CHIP).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 CHIP from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 CHIP in block rewards plus fees, but
