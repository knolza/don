...
RESOURCES += src/qt/gamblr.qrc src/qt/gamblr_locale.qrc
TRANSLATIONS += src/qt/locale/gamblr_bg.ts \
                src/qt/locale/gamblr_de.ts \
                src/qt/locale/gamblr_en.ts \
                src/qt/locale/gamblr_es.ts \
                src/qt/locale/gamblr_fi.ts \
                src/qt/locale/gamblr_fr.ts \
                src/qt/locale/gamblr_it.ts \
                src/qt/locale/gamblr_ja.ts \
                src/qt/locale/gamblr_pl.ts \
                src/qt/locale/gamblr_pt.ts \
                src/qt/locale/gamblr_ru.ts \
                src/qt/locale/gamblr_sk.ts \
                src/qt/locale/gamblr_sv.ts \
                src/qt/locale/gamblr_vi.ts \
                src/qt/locale/gamblr_zh_CN.ts \
                src/qt/locale/gamblr_zh_TW.ts
